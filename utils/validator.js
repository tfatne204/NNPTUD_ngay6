...
module.exports = {
    ...
    ChangePasswordValidator: [
        ...
        body("newPassword").notEmpty().withMessage("newPassword không được để trống").isStrongPassword({
            minLength: 8,
            minLowercase: 1,
            minNumbers: 1,
            minSymbols: 1,
            minUppercase: 1
        }).withMessage("newPassword dài ít nhất 8 ký tự, có ít nhất 1 chữ hoa, 1 chữ thường, 1 số và 1 ký tự đặc biệt")
    ],
    ModifyUserValidator: [
